...
/*bootstrap.*/}(this, function(lodash, Util, Timers, Observer, WebSocket) {
...
function ProxyPlayer(gameClient, player, nameReadOnly) {
    ...
    var setName  = lodash.debounce(this.setName.bind(this), ProxyPlayer.DebounceInterval);
    this.setName = function(name) {
        this.updateName.cancel();
        setName(name);
    }.bind(this);
    this.updateName  = lodash.debounce(Player.prototype.setName.bind(this), ProxyPlayer.DebounceInterval);
...
}, 'TicTacToe', ['./3rdparty/lodash', './Util', './Timers', './Observer', './WebSocket']));
