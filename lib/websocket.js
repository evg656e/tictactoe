...
export default (function() {
    if (typeof Qt === 'object') {
        return (function() {
            ...
            function WebSocket(url, protocols) {
                ...
                console.log('qtWebSocket created');
    ...
    //            this.qtWebSocket.url = url; // socket won't work
            ...
            WebSocket.prototype.statusChanged = function(status) {
                ...
                case WebSocket.ERROR:      if (this.qtWebSocket.active) this.dispatchEvent(new ErrorEvent(this.qtWebSocket.errorString, this)); break;
                default:                   break;
                }
            };
            ...
            WebSocket.prototype.destroy = function() {
                ...
                Qt.callLater(function() {
                    console.log('qtWebSocket destroyed');
